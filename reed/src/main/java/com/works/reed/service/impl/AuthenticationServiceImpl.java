...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse register(MemberDTO dto) {
        ...
        // 아이디 중복 체크
        Member member = Member.builder().memberId(dto.getMemberId()).memberPassword(passwordEncoder.encode(dto.getMemberPassword()))
                .roleSet(memberRoleConverter(dto.getRoles()))
                .memberName(dto.getMemberName()).memberEmail(dto.getMemberEmail()).memberTel(dto.getMemberTel()).build();
